...
import { createOrderAsync } from '../features/order/orderSlice'
 ...
 const Checkout = () =>
 {
  ...
  const handleOrder = (e) => {
    const order = {items, totalAmount, totalItem, user, selectedAddress, paymentMethod}
    ...
    return (
      <>
        ...
        <form noValidate className='bg-white px-5 py-5 mt-12' onSubmit={handleSubmit((data) => {
        ...
        <div>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              <input
                  type="tel"
                  {...register('phone', {required: "phone No Field is Required"})}
                  id="phone"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <input
                  type="text"
                  {...register('street', {required: "Street Field is Required"})}
                  id="street"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <input
                  type="text"
                  {...register('region', {required: "State Field is Required"})}
                  id="region"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <input
                  type="text"
                  {...register('pinCode', {required: "pinCode Field is Required"})}
                  id="pinCode"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
      ...
      {user.addresses.map((address, index) => (
        <li key={index} className="flex justify-between gap-x-6 py-5 border-solid border-2 border-gray-200 mt-4 px-5">
        ...
        <div className="mx-auto mt-20 bg-white max-w-7xl px-2 sm:px-2 lg:px-4">
       
       <div className="border-t border-gray-200 px-0 py-6 sm:px-0 mt-8">
