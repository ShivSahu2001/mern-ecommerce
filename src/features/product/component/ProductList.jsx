...
import { fetchAllBrandsAsync, fetchAllCategoriesAsync, fetchProductsByFilterAsync, selectAllProducts, selectBrands, selectCategory, selectTotalItems } from "../productSlice";
            ...
            {products.map((product) => (
              ...
              <Link to={`/product-detail/${product.id}`}  key={product.id}>
                <div
                  ...
                  className="group relative   border-solid border-2 p-2 border-gray-400"
                >
